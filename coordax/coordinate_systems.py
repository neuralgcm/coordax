...
class Coordinate(abc.ABC):
  ...
  def sel(
    ...
    unpacked_indexers, unpacked_c = _unpack_and_validate_indexers(indexers)
    ...
    unused_sel_indexers = set(indexers.keys()) - final_consumed
...
def _unpack_and_validate_indexers(
    indexers: dict[str | Coordinate, Any],
